...
import { updateTransaction } from "../services/firebaseService"
...
const UpdateTransaction = ({ user, transaction }: UpdateTransactionProps) => {
      ...
      <div className="min-h-screen">
        <div className="px-4 py-4 max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-center">
            ...
            <h1 className="text-lg font-semibold text-slate-900 dark:text-white text-center">Editar Transacción</h1>
          </div>
